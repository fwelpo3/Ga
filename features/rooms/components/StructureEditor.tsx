...
import { Project, Area, Room } from '../../../domain';
...
export const StructureEditor: React.FC<StructureEditorProps> = ({ project, setProject, onAddArea, onStartWithAi, onLearnTemplate }) => {
        ...
        <div className="flex-grow p-4 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
                 ...
                 <div className="flex items-center gap-2">
                    ...
                    <button onClick={onAddArea} className="flex items-center gap-2 bg-slate-600 text-white px-3 py-1.5 rounded-md text-sm font-semibold hover:bg-slate-500 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 focus:ring-offset-slate-800">
                ...
                {areas.length > 0 ? (
                    areas.map(area => (
                        <AreaCard
                            ...
                            onLearnTemplate={onLearnTemplate}
                            project={project}
                        />
                    ))
                ) : (
