...
export const DEFAULT_DEVICE_CONFIG: ProjectDeviceConfig = {
    lightSwitch: {
        ...
        feedbackVariant: 'inline',
        functions: [
            { name: "Schalten", dpt: "1.001", offset: 0, enabled: true },
            { name: "Schalten RM", dpt: "1.001", offset: 0, isFeedback: true, enabled: true },
        ],
    },
    lightDim: {
        label: "LD",
        ...
        functions: [
            ...
            { name: "Schalten RM", dpt: "1.001", offset: 0, isFeedback: true, enabled: true },
            { name: "Wert RM", dpt: "5.001", offset: 2, isFeedback: true, enabled: true },
        ],
    },
    blinds: {
        label: "J",
        ...
        functions: [
            ...
            { name: "Position Höhe RM", dpt: "5.001", offset: 2, isFeedback: true, enabled: true },
            { name: "Position Lamelle RM", dpt: "5.001", offset: 3, isFeedback: true, enabled: true },
        ],
    },
    heating: {
        label: "H",
